  ...
  return (
    <ProductPage
      ...
      specs={[
        ...
        { label: "Machine Width", value: "330 – 880 mm (standard common widths 330 mm and 450 mm)" },
        { label: "Imaging Width", value: "324 – 864 mm (standard common imaging widths 324 mm and 432 mm)" },
