    ...
    <PageShell title="About Orient" subtitle="Established in 1946, a legacy of excellence in printing machinery.">
      <div className="flex flex-col lg:flex-row gap-16">
        <div className="flex-1">
          ...
          <p className="text-[18px] font-medium text-white/60 leading-[1.6]">
        ...
        <div className="lg:w-[40%] shrink-0 space-y-5">
          <div className="bg-[#111] rounded-[6px] flex items-center justify-center" style={{ height: 300 }}>
            <span className="text-white/5 text-[14px] font-medium">Company Image</span>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[{ n: "79", l: "Years" }, { n: "20,000+", l: "Units" }, { n: "60+", l: "Countries" }, { n: "10", l: "Offices" }].map((s) => (
              <div key={s.l} className="bg-[#111] rounded-[6px] p-6">
                <span className="text-[28px] font-medium text-cream block">{s.n}</span>
                <span className="text-[14px] font-medium text-white/30">{s.l}</span>
              </div>
            ))}
          </div>
        </div>
