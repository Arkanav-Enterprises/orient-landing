      ...
      <div className="max-w-[720px]">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-black/[0.03] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-near-black mb-2">Original Parts</h3>
          ...
          <div className="p-6 bg-black/[0.03] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-near-black mb-2">Affordable Pricing</h3>
            <p className="text-[16px] font-medium text-near-black/50 leading-[1.5]">
          ...
          <div className="p-6 bg-black/[0.03] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-near-black mb-2">Spares Stock Advisory</h3>
            <p className="text-[16px] font-medium text-near-black/50 leading-[1.5]">
