      ...
      <div className="max-w-[720px]">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-[#111] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-white mb-2">Tailored Financing</h3>
          ...
          <div className="p-6 bg-[#111] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-white mb-2">Leasing Partnerships</h3>
            <p className="text-[16px] font-medium text-white/50 leading-[1.5]">
          ...
          <div className="p-6 bg-[#111] rounded-[6px]">
            <h3 className="text-[18px] font-medium text-white mb-2">Banking Partnerships</h3>
            <p className="text-[16px] font-medium text-white/50 leading-[1.5]">
