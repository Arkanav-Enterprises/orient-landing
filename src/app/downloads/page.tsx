  ...
  return (
    <PageShell title="Downloads" subtitle="Product catalogs, brochures, and technical documentation.">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {catalogs.map((c) => (
          <div key={c} className="flex items-center justify-between p-5 bg-black/[0.03] rounded-[6px] group cursor-pointer hover:bg-black/[0.06] transition-colors">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[15px] font-medium text-near-black/60">{c}</span>
            </div>
